 ...
 * <p>
 * Esta interfaz extiende {@link JpaRepository} y proporciona métodos para
 * realizar operaciones de búsqueda y verificación sobre la entidad
 * {@link Incidencia} utilizando identificadores compuestos.
 * </p>
 */
@Repository
public interface IIncidenciaRepository extends JpaRepository<Incidencia, Long>
{
	 ...
	 * @return lista de Incidencias ordenadas por fecha de forma decreciente por
	 *         usuario
	 */
	@Query("""
				SELECT new es.iesjandula.reaktor.issues_server.dtos.IncidenciaDto(i.id,
	 ...
	 * <p>
	 * Este método verifica si existen incidencias asociadas a una categoría en la
	 * base de datos.
	 * </p>
	 * 
	 * @param nombre El nombre de la categoría.
	 * @return {@code true} si existen incidencias asociadas a la categoría;
